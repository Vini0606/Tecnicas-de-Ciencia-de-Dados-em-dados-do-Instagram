...
\usepackage{lmodern}			% Fontes Latin Modern escaláveis (evita erro do microtype com negrito+monoespaçado)
\usepackage{indentfirst}		% Indenta o primeiro parágrafo de cada seção.
\usepackage{color}
\usepackage{xcolor} % Controle das cores
\usepackage{graphicx}			% Inclusão de gráficos
\usepackage{microtype} 			% para melhorias de justificação
\usepackage{booktabs}			% linhas de tabela no estilo "profissional" (usado nas tabelas dos capítulos)
% \usepackage[toc,page]{appendix} % REMOVIDO: dá "Option clash" com o appendix emulado pelo memoir (base do abntex2);
                                   % nenhum comando específico do pacote appendix é usado no documento.
...
\usepackage{seqsplit}   % permite quebra de strings longas sem espaços
\newcommand{\code}[1]{\seqsplit{#1}}
...
\begin{center}
   {\textbf{\Large  \textbf{Vinícius de Paula R Carvalho}}}\\[2 cm]
      {\textbf{\Large Uma abordagem híbrida de mineração de texto e aprendizado não supervisionado como ferramenta de \textit{growth} para assessorias políticas: análise de engajamento no Instagram dos governadores brasileiros. }}\\[2cm]
...
\clearpage
\begin{center} 
    \textbf{\LARGE{Uma abordagem híbrida de mineração de texto e aprendizado não supervisionado como ferramenta de \textit{growth} para assessorias políticas: análise de engajamento no Instagram dos governadores brasileiros.}}\\ [3cm]
...
\include {Capítulos/Capitulo_01_Introdução}

\include {Capítulos/Capitulo_02_Objetivos}

\include {Capítulos/Capitulo_03_Referencial_Teórico}

\include {Capítulos/Capitulo_04_Fontes_de_Dados}

\include {Capítulos/Capitulo_05_Modelagem}

\include {Capítulos/Capitulo_06_Resultados}

\include {Capítulos/Capitulo_07_Conclusões}
