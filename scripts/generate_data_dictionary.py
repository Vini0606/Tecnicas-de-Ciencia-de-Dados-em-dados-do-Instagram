...
TABLES: list[dict] = [
    ...
    },
    {
        ...
        "notas": "Roda pós-Gold-de-engajamento (lê governor_engagement), dentro do mesmo estágio determinístico das demais tabelas de modelagem -- na Lambda serverless, é a etapa `model`, disparada depois de `load` (ver seção 3 do README).",
    },
    {
        "camada": "Gold",
